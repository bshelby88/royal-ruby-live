...
for drop in DROPS:
    ...
    data = {
        ...
        "token": {
            ...
            "external_url": "https://royalruby.io/nft",
        },
        "claim": {
            "type": "open",
            "price": "0.0025",
