...
const PLAN = [
  ...
  },
  {
    ...
    link: 'https://royalruby.io/ig',
  },
  {
    day: 2, hour: 9,
    video: '03-oldest-card',
    platforms: ['youtube'],
    caption: "Don't Close Your Oldest Credit Card — Dr. Marigny explains why. Free 90-day reset checklist: royalruby.io",
    link: 'https://royalruby.io/yt',
  },
  {
    day: 3, hour: 19,
...
async function scheduleMetricool({ video, caption, platforms, publishAt }) {
  ...
  const res = await fetch(endpoint, {
    ...
    body: JSON.stringify({
      text: caption,
      media: [{ url: `https://royalruby.io/videos/${video}.mp4`, type: 'video' }],
      providers: platforms,
